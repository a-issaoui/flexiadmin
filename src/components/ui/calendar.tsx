    ...
    <DayPicker
      ...
      components={{
        ...
        Chevron: ({ className, orientation, ...props }) => {
          if (orientation === "left") {
            return (
              <Icon name="CaretLeftIcon" size={16} className={cn(className)} {...props} />
            )
          }

          if (orientation === "right") {
            return (
              <Icon name="CaretRightIcon" size={16} className={cn(className)} {...props} />
            )
          }

          return (
            <Icon name="CaretDownIcon" size={16} className={cn(className)} {...props} />
          )
        },
